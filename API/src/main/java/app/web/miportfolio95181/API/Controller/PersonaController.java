...
import app.web.miportfolio95181.API.Service.PersonaService;
...
public class PersonaController {
    ...
    public ResponseEntity<Persona> agregarPersona(@RequestBody Persona persona) {
        Persona nuevoPersona = personaService.agregarPersona(persona);
        return new ResponseEntity<>(nuevoPersona, HttpStatus.OK);
    }
